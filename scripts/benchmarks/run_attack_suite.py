...
MANIFEST_PATH = Path("outputs/benchmark_results/attack_suite_manifest.json")
MASTER_JSONL = Path("outputs/benchmark_results/attack_suite_master_log.jsonl")
MASTER_CSV = Path("outputs/benchmark_results/attack_suite_master_log.csv")
LOG_DIR = Path("outputs/benchmark_logs")
...
CSV_FIELDS = [
    ...
    "best_validation_metric", "final_validation_metric", "best_test_accuracy_under_attack",
    "final_test_accuracy_under_attack", "attack_success_rate", "total_runtime", "notes_errors"
]
...
def do_dry_run(rows, force=False):
    ...
    out = Path("outputs/benchmark_results/attack_suite_dry_run.json")
...
def run_one(row, python_bin=sys.executable):
    ...
    result = {
        ...
        "attack_config_name": row["attack_config_name"],
        ...
        "best_test_accuracy_under_attack": summary.get("best_test_accuracy") if summary else None,
        "final_test_accuracy_under_attack": summary.get("final_test_accuracy") if summary else None,
    ...
    for row in rows:
        ...
        try:
            ...
            fail = {
                ...
                "best_test_accuracy_under_attack": None,
                "final_test_accuracy_under_attack": None,
